...
const HeroSection = () => {
  return (
    ...
    />
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg lg:text-xl">I am a full-stack developer </p>
        ...
        <div className="col-span-5 place-self-center mt-4 ">
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px] relative">
            <Image
              src="/hero-image.png"
              alt="hero-image"
              className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" width={300} height={300}
            ></Image>
          </div>
        </div>
      </div>
